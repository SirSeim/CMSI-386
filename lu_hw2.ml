(* Name: Adrian Lu
   ...
   Others With Whom I Discussed Things: Edward Seim, Joshua Kuroda, 
...
let intOfDigits (l : int list) : int = 
    fold_left (multiplicate n x) 0 l
...
(* let rec map2 (funk : ('a -> 'b -> 'c)) (l1 : 'a list) (l2 : 'b list) : 'c list =
